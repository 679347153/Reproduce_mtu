...
class BERTLanguageEncoder(nn.Module):
    def __init__(self, cfg, weights="bert-base-uncased", hidden_size=768,
        ...
        # )
        local_bert_path = "/home/ma-user/work/zhangWei/mtu3d/data/trans/bert-base-uncased"  # 修改为你的本地路径
        self.tokenizer = BertTokenizer.from_pretrained(local_bert_path, do_lower_case=True)
        self.model = BertModel.from_pretrained(local_bert_path, config=self.bert_config)
