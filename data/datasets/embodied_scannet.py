...
'''
class EmbodiedScanNet(Dataset, ABC):
    ...
    def _load_one_scan(self, scan_id):
        ...
        sub_frame_list = os.listdir(os.path.join(self.embodied_base_dir, 'points', scan_id))
        for sub_frame in sub_frame_list:
...
class EmbodiedScanNetInstSeg(EmbodiedScanNet):
